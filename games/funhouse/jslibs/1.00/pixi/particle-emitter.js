...
(function (exports, core, constants, sprite, math, ticker$1, display) {
    ...
    function upgradeConfig(config, art) {
        ...
        else if (art && typeof art !== 'string' && 'framerate' in art) {
    ...
    module.exports = {Emitter,LinkedListContainer,Particle,ParticleUtils,PropertyList,PropertyNode,index$1,upgradeConfig}

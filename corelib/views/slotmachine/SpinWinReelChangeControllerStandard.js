...
class SpinWinReelChangeControllerStandard {
    constructor() {
        this.symbolsArray = [];
        this.stage = null;
        this.winIndex = 0;
                ...
                for (let k = 0; k < len; k++) {
                    ...
                    if (posLen > 0) {
                        for (let i = 0; i < posLen; i++) {
                            ...
                            this.showSymbolLineWin(lineWin[i].reel, lineWin[i].row + 1, lineWin[i].symbol, this.stage.configData.data.showFrameForAllWin, true);
    ...
    showSymbolLineWin(reel, row, symbol, showFrame = false, isAllWin = false) {
    ...
    showLineWin() {
        ...
        if (winlines && winlines.length > 0) {
            ...
            if (obj) {
                ...
                if (posLen > 0) {
                    for (let i = 0; i < posLen; i++) {
                        this.showSymbolLineWin(lineWin[i].reel, lineWin[i].row + 1, lineWin[i].symbol, this.stage.configData.data.showFrameForAllWin, false);
                        this.winningSymbolsArray.push(this.symbolsArray[lineWin[i].reel][lineWin[i].row + 1]);
                    }
                }
...
export const spinWinControllerRC = new SpinWinReelChangeControllerStandard();

...
export class LibButton extends PIXI.Container {
    constructor(options) {
        super();
    ...
    createView () {
        ...
        if (this.configData.textConfig) {
            ...
            CoreLib.UIUtil.alignToObject(this.tText, "middle", this.btn, CoreLib.Util.getDefaultValue(this.tText.configData.vPadding, 0));
        }

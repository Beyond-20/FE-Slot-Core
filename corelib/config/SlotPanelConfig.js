export const SLOT_PANEL_CONFIG = {
    name: "slotPanelComp", type: "Comp", class: "SlotPanelComp",
    Elements: [
        ...
        { name: "spinBtn", type: "Comp", class: "SpinButton", images: ["bigCircleButton_up", "bigCircleButton_over", "bigCircleButton_down"], icon: ["spinIcon", "spinIcon", "spinIcon"], x: 2134, y: -65 },
        { name: "stopspinBtn", type: "Comp", class: "SpinButton", images: ["bigCircleButton_up", "bigCircleButton_over", "bigCircleButton_down"], icon: ["stopspinIcon", "stopspinIcon", "stopspinIcon"], x: 2134, y: -65 },
        ...
        {
            name: "balanceComp", type: "Comp", class: "BalanceComp", x: 1816, y: 20,
            Elements: [
        ...
        {
            name: "winComp", type: "Comp", class: "PanelWinComp", x: 944, y: 46,
            Elements: [
                ...
                { name: "valueText", type: "Text", contentText: "0", style: "commonFontStyle", fontSize: 42, mFontSize: 54, anchor: { x: 0.5, y: 0 }, y: 20, my: 16 }
            ]
        },
        {
            name: "fsWinComp", type: "Comp", class: "FSPanelWinComp", x: 934, y: 40,
            Elements: [
                { name: "winBG", type: "Sprite", image: "winbg", portraitimage: "winbgPortrait", landscapeimage: "winbgLandscape" },
        ...
        {
            name: "stakeComp", type: "Comp", class: "StakeComp", x: 620, y: 20,
            Elements: [
